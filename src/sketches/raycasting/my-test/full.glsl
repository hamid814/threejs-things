...
float traceOuter2(vec3 rayOrigin, vec3 rayDirection, float eta) {
  ...
  if(d < MAX_DIST) {
    ...
    power += traceOuter1(pos + reflection, -reflection, eta) * reflectionFadePower;
  }
  return power;
}
...
float traceOuter3(vec3 rayOrigin, vec3 rayDirection, float eta) {
  ...
  if(d < MAX_DIST) {
    ...
    power += traceOuter2(pos + reflection, -reflection, eta) * reflectionFadePower;
  }
  return power;
}
...
float traceOuter4(vec3 rayOrigin, vec3 rayDirection, float eta) {
  ...
  if(d < MAX_DIST) {
    ...
    power += traceOuter3(pos + reflection, -reflection, eta) * reflectionFadePower;
  }
  return power;
}
...
float traceOuter5(vec3 rayOrigin, vec3 rayDirection, float eta) {
  ...
  if(d < MAX_DIST) {
    ...
    power += traceOuter4(pos + reflection, -reflection, eta) * reflectionFadePower;
  }
  return power;
}
