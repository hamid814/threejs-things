...
void main() {
  ...
  float b1 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseN1));
  float b2 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseN2));
  float b3 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseN3));
  float b4 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseN4));
  float b5 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseN5));

  float r1 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseP1));
  float r2 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseP2));
  float r3 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseP3));
  float r4 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseP4));
  float r5 = smoothstep(0.0, 0.1, (distance(ratioUV, vec2(0.5)) - noiseP5));
