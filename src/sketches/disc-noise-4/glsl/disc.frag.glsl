...
void main() {
  ...
  float b1 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseN1), 0.1, 0.15);
  float b2 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseN2), 0.1, 0.15);
  float b3 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseN3), 0.1, 0.15);
  float b4 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseN4), 0.1, 0.15);
  float b5 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseN5), 0.1, 0.15);

  float r1 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseP1), 0.1, 0.15);
  float r2 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseP2), 0.1, 0.15);
  float r3 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseP3), 0.1, 0.15);
  float r4 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseP4), 0.1, 0.15);
  float r5 = 1.0 - smoothstep(abs(distance(ratioUV, vec2(0.5)) - noiseP5), 0.1, 0.15);
  ...
  gl_FragColor = vec4(r5, b1, b1, 1.0);
  gl_FragColor = vec4(r5 + b5, r5 + b5, r5 + b5, 1.0);
