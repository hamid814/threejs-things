...
void main() {
  ...
  float b1 = step(abs(distance(ratioUV, vec2(0.5)) - noiseN1), 0.001);
  float b2 = step(abs(distance(ratioUV, vec2(0.5)) - noiseN2), 0.001);
  float b3 = step(abs(distance(ratioUV, vec2(0.5)) - noiseN3), 0.001);
  float b4 = step(abs(distance(ratioUV, vec2(0.5)) - noiseN4), 0.001);
  float b5 = step(abs(distance(ratioUV, vec2(0.5)) - noiseN5), 0.001);

  float r1 = step(abs(distance(ratioUV, vec2(0.5)) - noiseP1), 0.001);
  float r2 = step(abs(distance(ratioUV, vec2(0.5)) - noiseP2), 0.001);
  float r3 = step(abs(distance(ratioUV, vec2(0.5)) - noiseP3), 0.001);
  float r4 = step(abs(distance(ratioUV, vec2(0.5)) - noiseP4), 0.001);
  float r5 = step(abs(distance(ratioUV, vec2(0.5)) - noiseP5), 0.001);
