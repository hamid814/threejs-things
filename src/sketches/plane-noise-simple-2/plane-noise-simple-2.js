...
const fragmentShader = `
  ...
  void main() {
    ...
    float noise = abs(cnoise(vec3(vUv.x * noiseFactor, vUv.y * noiseFactor, uTime / 10.0)));
    float strength = step(0.5, sin(noise * 30.0));
    ...
    gl_FragColor = vec4(vec3(strength, strength / 1.5, blue), 1.0);
  }
`;
